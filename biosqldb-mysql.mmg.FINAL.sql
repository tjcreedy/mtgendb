...
ALTER TABLE bioentry ADD CONSTRAINT FKmaster_bioentry
	FOREIGN KEY (name) REFERENCES master(db_id)
	ON DELETE CASCADE;
...
-- metadata
ALTER TABLE metadata ADD CONSTRAINT FKmaster_meta
	FOREIGN KEY (db_id) REFERENCES master(db_id)
	ON DELETE CASCADE;
