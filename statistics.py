...
def calculations(df_features):
    ...
    f.write("Gene number:\nNumber of genes is 13:\t" + str(genes) + "\t(" + str(genes_p) + "%)\n")
    f.write("More than 13 genes:\t" + str(more)+"\t(" + str(more_p) + "%)\n")
    f.write("Fewer than 13 genes:\t" + str(less) + "\t(" + str(less_p) + "%)\n\n")
    ...
    f.write("CDS number:\nNumber of CDSs is 13:\t" + str(cds) + "\t(" + str(cds_p) + "%)\n")
    f.write("More than 13 CDSs:\t" + str(morec)+"\t(" + str(morec_p) + "%)\n")
    f.write("Fewer than 13 CDSs:\t" + str(lessc) + "\t(" + str(lessc_p) + "%)\n\n")
    ...
    f.write("tRNA number:\nNumber of tRNAs is 22:\t" + str(trnas) + "\t(" + str(trnas_p) + "%)\n")
    f.write("More than 22 tRNAs:\t" + str(moretr)+"\t(" + str(moretr_p) + "%)\n")
    f.write("Fewer than 22 tRNAs:\t" + str(lesstr) + "\t(" + str(lesstr_p) + "%)\n\n")
    ...
    f.write("rRNA number:\nNumber of rRNAs is 2:\t" + str(srnas) + "\t(" + str(srnas_p) + "%)\n")
    f.write("More than 2 rRNAs:\t" + str(moresr) + "\t(" + str(moresr_p) + "%)\n")
    f.write("Fewer than 2 rRNAs:\t" + str(lesssr) + "\t(" + str(lesssr_p) + "%)\n\n")
...
##For seq length and each feature calculate mean, std, median, min and max values
...
def calculations_ftr(df_features):
    ...
    for ftr,name in zip([lengths, genes, cdss, trnas, rrnas], feature_names):
        ...
        f.write(str(name) + ":\n")
        f.write("mean = " + str(m) + ", std = " + str(std) + ", median = " + str(md) + ", range = " + str(mi) + " - " + str(ma) + "\n")
...
def length_variation(gene_lengths):
    ...
    for gene in gene_names:
        ...
        f.write(str(gene) + ":\n")
        f.write("mean = " + str(m) + ", std = " + str(std) + ", var = " + str(var) + ", median = " + str(md) + ", range = " + str(mi) + " - " + str(ma) + "\n")
...
def analyze_order(order):
    ...
    ancestral_order = ("COX1", "COX2", "ATP8", "ATP6", "COX3", "ND3", "ND5", "ND4", "ND4L", "ND6", "CYTB", "ND1", "ND2", "COX1", "COX2", "ATP8", "ATP6", "COX3", "ND3", "ND5", "ND4", "ND4L", "ND6", "CYTB", "ND1", "ND2")
    different_order = {}
    ...
    for entry in order:
        ...
        if genes:
            ...
            if isexactsubset(genes,ancestral_order) == False:
...
def gene_sequence(genbank_dict):
    """Save genes sequences in fasta-file (one file for complete sequences only, one for both complete or partial sequences).
    """
